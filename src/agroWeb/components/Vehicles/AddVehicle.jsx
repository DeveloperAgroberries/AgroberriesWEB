					...
					<form>
						...
						<div className="row mb-2">
							<div className="col-md-4">
								...
								<input style={{ fontSize: '13px' }} required type="text" className="form-control" aria-describedby="emailHelp" name='plate' value={plate} onChange={onInputChange} onKeyDown={(e) => checkSpecialCharForPlate(e)} onPaste={onPaste} />
								<div className="form-text">Evitar el caracter "-" al ingresar las placas del vehiculo.</div>
							</div>
							<div className="col-md-4">
								<label className="form-label">Capacidad</label>
								<input style={{ fontSize: '13px' }} required type="number" className="form-control" aria-describedby="emailHelp" min="0" step="1" name='capacity' value={capacity} onChange={onInputChange} onKeyDown={(e) => checkChar(e)} onPaste={onPaste} />
							</div>
							<div className="col-md-4">
								<label className="form-label">Tipo De vehiculo</label>
								<select style={{ fontSize: '13px' }} required className="form-select" name='vehicleType' value={vehicleType} onChange={onInputChange}>
						...
						<div className="row mb-3 align-items-end">
							...
							<select style={{ fontSize: '13px' }} required className="form-select" name='provider' value={provider} onChange={onInputChange}>
								<option hidden value="">Seleccion</option>
