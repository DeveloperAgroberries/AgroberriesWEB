...
export const VehiculosPage = () => {
	...
	const openVehiclePopup = (component) => setIsPopupOpen(component);
			...
			<div id="pagesContainer" className="container-fluid h rounded-3 p-3 mt-5 animate__animated animate__fadeIn">
				...
				<div className="d-flex flex-wrap align-items-end m-1">
					<div style={{ marginTop: '1px' }}>
						<label className="form-label m-1">Registro y consulta de Vehiculos.</label>
					</div>
					
					<div className="mb-2 ms-auto ms-5" style={{ width: '500px' }}>
						<div><p className="m-1 me-3 sizeLetra">Buscar:</p></div>
						<input type="text" className="form-control" placeholder="Buscar por placas..." style={{ width: '500px' }}  value={searchTerm} onChange={handleSearchChange} />
					</div>
				</div>
					...
					<table className="table table-striped table-hover">{/* Puedes añadir tus propias clases CSS */}
						<thead style={{ position: 'sticky', top: '0', zIndex: '1' }}>
							<tr>
								...
								<th scope="col" className="text-center">Vehiculo Activo</th>
						...
						<tbody>
							<VehiclesList
								...
								closeVehiclePopup={closeVehiclePopup}
				...
				<div className="ms-2 mb-1 mt-2">
					<button className="btn btn-warning rounded-2 m-1" onClick={() => openVehiclePopup(<AddVehicle onClose={closeVehiclePopup} />)}><i className="fas fa-bus fa-lg"></i> Agregar Nuevo Vehiculo</button>
