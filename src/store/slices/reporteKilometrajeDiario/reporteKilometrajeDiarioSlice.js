...
export const reporteKilometrajeDiarioSlice = createSlice({
    name: 'activosFijos', // Nombre del slice
    
    initialState: {
        // 1. Para manejar el estado de carga (loading)
        isLoading: false,
        // 2. Para almacenar los datos de las kilometrajes consultadas
        kilometrajes: [],
    ...
    reducers: {
        ...
        getReporteKilometraje: (state, action) => {
            state.isLoading = false;
            state.kilometrajes = action.payload.kilometrajes;
...
export const { checkingIsLoading, getReporteKilometraje, ADD_REGISTRO_ERROR } = activosFijosSlice.actions;