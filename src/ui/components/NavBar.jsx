						...
						<ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
							...
							<li className="nav-item dropdown">
								...
								<ul className="dropdown-menu">
									...
									{user?.permissions.includes("02550") && (
										<>
											<li className="nav-item dropdown">
												<a className="dropdown-item dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
													Reclutadores
												...
												<ul className="dropdown-menu-end">
													...
													{user?.permissions.includes("02551") && (
														<li className='nav-item'>
										...
										<>
											<li className="nav-item dropdown">
												...
												<ul className="dropdown-menu-end">
													...
													{user?.permissions.includes("02572") && (
														<li className='nav-item'>
															<NavLink className={({ isActive }) => `rounded-1 dropdown-item ${isActive ? 'active' : ''}`} to="/solicitudCajas" onClick={() => {navigate("/solicitudCajas");}} data-bs-dismiss="offcanvas">
																Registro de cajas
															</NavLink>
														</li>
													)}
							...
							<li className="nav-item dropdown">
								...
								<ul className="dropdown-menu">
									...
									{user?.permissions.includes("02600") && (
										<>
											<li className="nav-item dropdown">
												<a className="dropdown-item dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
													Rinde Gastos
												...
												<ul className="dropdown-menu-end">
													...
													{user?.permissions.includes("02601") && (
														<li className='nav-item'>
